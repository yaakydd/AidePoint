...
#
# Returns a tuple (model_input, raw_resized_bgr) instead of just
# model_input. The reliability gate and shape screening both need actual
# pixel values — hue, saturation, corner brightness, cell contours — which
# the ImageNet-normalized tensor doesn't preserve in a usable form.
# Decoding once and handing back both avoids reading the image twice.
