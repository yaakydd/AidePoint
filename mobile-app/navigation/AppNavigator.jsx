...
const AppNavigator = () => {
  ...
  // NavigationContainer is the root of ALL navigation.
  // There must be exactly ONE NavigationContainer in your app.
  // Everything else (Stack, Tabs, Drawers) goes inside it.
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        {user ? (
          // user object exists → person is logged in → show the app
